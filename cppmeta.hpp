...
namespace cppmeta
{
    ...
    public:
        ...
        Entity(const Member<ClassT, T ClassT::*>& member)
            : EntityInfo(member)
            , _entity(member)
            , get_underlying_entity_value(reinterpret_cast<get_underlying_entity_value_t>(&get_underlying_entity_value_impl<Member<ClassT, T ClassT::*>/**/>))
            , get_underlying_entity_info(reinterpret_cast<get_underlying_entity_info_t>(&get_underlying_entity_info_impl<Member<ClassT, T ClassT::*>/**/>))
        ...
        Entity(const Member<ClassT, T>& member)
            : EntityInfo(member)
            , _entity(member)
            , get_underlying_entity_value(reinterpret_cast<get_underlying_entity_value_t>(&get_underlying_entity_value_impl<Member<ClassT, T>/**/>))
            , get_underlying_entity_info(reinterpret_cast<get_underlying_entity_info_t>(&get_underlying_entity_info_impl<Member<ClassT, T>/**/>))
            , stored_member_type_id(type_id<T>())
            , stored_class_type_id(type_id<ClassT>())
        ...
        Entity(const Value<T>& value)
            : EntityInfo(value)
            , _entity(value)
            , get_underlying_entity_value(reinterpret_cast<get_underlying_entity_value_t>(&get_underlying_entity_value_impl<Value<T>/**/>))
            , get_underlying_entity_info(reinterpret_cast<get_underlying_entity_info_t>(&get_underlying_entity_info_impl<Value<T>/**/>))
            , stored_member_type_id(type_id<T>())
        ...
        Entity(const Object<T>& object)
            : EntityInfo(object)
            , _entity(object)
            , get_underlying_entity_value(reinterpret_cast<get_underlying_entity_value_t>(&get_underlying_entity_value_impl<Object<T>/**/>))
            , get_underlying_entity_info(reinterpret_cast<get_underlying_entity_info_t>(&get_underlying_entity_info_impl<Object<T>/**/>))
            , stored_member_type_id(type_id<T>())
            , stored_class_type_id(0)
